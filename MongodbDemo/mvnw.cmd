...
@REM To isolate internal variables from possible parcel scripts, we use another setlocal
@setlocal
...
@REM check for parcel script, once with legacy .bat ending and once with .cmd ending
